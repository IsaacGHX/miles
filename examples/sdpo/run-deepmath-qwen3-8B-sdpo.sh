...
export EVAL_DATASET_NAME="${EVAL_DATASET_NAME:-deepmath_val}"
export EVAL_PROMPT_DATA="${EVAL_PROMPT_DATA:-}"
export N_SAMPLES_PER_EVAL_PROMPT="${N_SAMPLES_PER_EVAL_PROMPT:-1}"
export EVAL_MAX_RESPONSE_LEN="${EVAL_MAX_RESPONSE_LEN:-$ROLLOUT_MAX_RESPONSE_LEN}"
export EVAL_TEMPERATURE="${EVAL_TEMPERATURE:-0}"
export SKIP_EVAL_BEFORE_TRAIN="${SKIP_EVAL_BEFORE_TRAIN:-false}"
